import { ok, text } from '@/presentation/helpers'
import { Controller, HTTPResponse } from '@/presentation/protocols'

export class AttributesDetailsController implements Controller {
  attributesDetails = {
    strength: text`The character's physical strength. The Strength
      ...
      pull objects, etc.`,
    dexterity: text`The character's speed, agility and manual skill.
      ...
      fighting style.`,
    constitution: text`The character's physical resistance, his breath,
